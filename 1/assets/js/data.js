...
var dataRecd=[  {    
		...
		{	
					...
					'aslash':[[0]],
					'anumbering':['0 2','0 0'],
					'hintt':['This is a hyphenated surname. Follow rule 3 in coding, and prepare a cross-reference card. Code the cross-reference card as shown in the example.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[20,2],
					'crossAns':[[['Anderson','Jennifer','Taylor','','','','','','SEE TaylorAnderson Jennifer'],[1,4]]]	
					}, // 3 
				{	
					...
					'folderinfo':[],
					'ansOrder':[19,0],
					'crossAns':[[['Stop','on','a','Dime','Assets','','','','SEE SODA Inc'],[19,3]]]	
					}, // 4 
				{	
					...
					'folderinfo':[],
					'ansOrder':[18,5],
					'crossAns':[[['Underwood','Amanda','Rustin','','','','','','SEE RustinUnderwood Amanda'],[21,1]]]	
					}, // 5 
				{	
				    'name':[['J. R. Andersen'],['11044 Overlook Dr. W.'],['Waukegan, IL 60085-1044'],['847-555-0101']],
				    'aslash':[[0,1]],
					'anumbering':['0 4','0 0','0 2'],
				...
				{	
					...
					'folderinfo':[],
					'ansOrder':[18,2],
					'crossAns':[[['Ahmad','Rostamian','','','','','','','SEE Rostamian Ahmad'],[1,1]]]	
					}, // 8 
						{	
					...
					'folderinfo':[],
					'ansOrder':[19,1],
					'crossAns':[[['Raj','Solanki','','','','','','','SEE Solanki Raj'],[18,0]]]
					}, // 10 
						{	
					...
					'folderinfo':[],
					'ansOrder':[20,0],
					'crossAns':[[['Unrah','and','Taylor','Brokerage','','','','','SEE Taylor and Unrah Brokerage'],[21,2]]]	
					}, // 12 
						{	
				    'name':[['Nancy Russell-Anderson'],['8900 E. Waldon St.'],['Northbrook, IL 60062-8900'],['847-555-0112']],
					'aslash':[[0]],
					'anumbering':['0 2','0 0'],
					'hintt':['This card also needs a cross reference because of the hyphenated surname.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[18,4],
					'crossAns':[[['Anderson','Nancy','Russell','','','','','','SEE RussellAnderson Nancy'],[1,5]]]	
					}, // 13 
						{	
...
var audhintSeq={"hint_0":["hint_0"],"hint_1":["hint_1"],"hint_2":["hint_2"],"hint_3":["hint_3"],"hint_4":["hint_4"],"hint_5":["hint_5"],"hint_6":["hint_6"],"hint_7":["hint_7"],"hint_8":["hint_8"],"hint_10":["hint_10"],"hint_12":["hint_12"],"hint_13":["hint_13"]}
...
var audCcTxt = 	{
			'startbtn':['Welcome to Job 1 of the Records Management Simulation. Take a moment to review the alphabetic filing rules, the cross-reference rules, and directions for the module by clicking on the respective buttons.'],
			'directionsforjobs':[''],
			'overviewofauric':[''],
			'overviewofjob':[''],
			'sorting':[''],
