...
var putNumber = function(passObj,applyTo,slashAns){		//alert($(applyTo).parent().attr('class'));
        if( /iPhone|iPad|iPod/i.test(navigator.userAgent) ) {
	        $('.substeping .names span').css({marginTop:'4px',marginBottom:'7px',height:'20px'});
			$('.subinput input').css({height:'20px'});
			$('.panelContainer  .substeping .names span').css({marginTop:'4px',marginBottom:'9px',height:'20px'});
			$('#reviewAns .substeping .names span').css({marginTop:'4px',marginBottom:'11px',height:'20px',top: '11px'});
		}
        ...
        if( /iPhone|iPad|iPod/i.test(navigator.userAgent) ) {
			if($('.simworkarea').hasClass('scaleCard')){
				 $('.scaleCard .substeping .num').css({lineHeight:'32px'});
			}
		}
...
var enableEventlevel = function(mainObj,toThs,slashAns) {
	...
	$('.floatRightauric2   #name_3_0 span:first-child,.floatLeftFax1  #name_5_0 span:first-child,.leftRightParallel #name_2_1 span:first-child,.noCode6  #name_2_1 span:first-child,.noCode9  #name_2_0 span:first-child,.noCode3  #name_2_2 span:first-child,.noCode3  #name_2_2 span:first-child,.floatleftIndentnew #name_12_0 span:first-child').addClass('notclick');
}
