...
var chngQues = function(currQues) {	
	...
	if(cloneArr.length==0){
			...
			$('.offSteps').css('width','175px').css('height','88px').show();
			$('.offHint').css('width','175px').css('height','40px').show();
			$('.simbtn,.crossbtn, .hintbtn, .inspectSimbtn').css('background','#5a4a42').css('cursor','default').css('opacity','0.5');
			$('#fileHint').css('background','rgb(161, 160, 161) none repeat scroll 0% 0%').css('cursor','default').css('opacity','0.5');
			$('.dummy').show();
			$('.dummySubbtn').hide();
...
var splitName = function(getName,addClass,addLabel) {
   ...
   $('<div/>',{id:'latteradd'+index, class:splVal.alignClass[index]}).appendTo(addClass+' #latteradd'+(index-1));
			if($('.simworkarea').hasClass('scaleCard') && addClass.indexOf('nameing') > -1){
              ...
              //alert(spTop) 
			$(addClass+' #latteradd'+index).css({position:'absolute',right:'38px',top:0+'px'});
		...
		$.each(value,function(ind,val){
			...
			{
				$('<div/>',{id:'namesub_'+index+'_'+ind,class:'names nameing_'+index}).appendTo(addClass+' #latteradd'+index).html('<div ><form><div><div class="fieldDiv"> <div class="labelLeft">SUBJECT CODE:</div><div class="InputRight"><input type="text" style="width:138px;" name="userid"></div></div><div class="fieldDiv"> <div class="labelLeft">Additional Unit:</div><div class="InputRight"><input  style="width:138px;" type="text" name="userid"></div></div><div class="fieldDiv"> <div class="labelLeft">Additional Unit:</div><div class="InputRight"><input  style="width:138px;" type="text" name="userid"></div></div><div class="fieldDiv"> <div class="labelLeft">Additional Unit:</div><div class="InputRight"><input type="text" name="userid"  style="width:138px;" ></div></div></div><div class="fieldDiv"> <div class="labelLeft">Additional Unit:</div><div class="InputRight"><input type="text" style="width:138px;" name="userid"></div></div><div class="fieldDiv"> <div class="labelLeft">Additional Unit:</div><div class="InputRight"><input type="text" style="width:138px;" name="userid"></div></div></form></div>');
			}
			else
			{
