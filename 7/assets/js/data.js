...
var findAddedCorrectName =[['CHICAGO','F','Folder',                   'CHICAGO','S','Special Guide','guidesp'],
						   ['CHICAGO','S','Special Guide',                    'C','G','Guide','guide']]
						   

		// Types F - folder, S- Special Guide, G - Guide
var foldertypeandName =[["G","NUMBERS",'old'],//20      28
						["F","99 ELECTRONIC REPAIR SHOP",'old'],//19     27
						["F","NUMBERS",'old'],//18      26
						["G","A",'old'],//17    25
						["F","ABOVE AND BEYOND INSURANCE CO",'old'],//16    24
						["S","APPLICATIONS",'old'],//15    23
						["F","APPLICATIONS",'old'],//14    22
						["F","A",'old'],//13   21 
						["G","B",'old'],//12   20
						["F","B",'old'],//11   19
						["G","C",'old'],//10   18
						...
						["F","E",'old'],//5    13
						["G","I",'old'],//4    12
						["F","INTERNATIONAL COMPUTING CENTER",'old'],	//3   11
						["S","INVOICES",'old'],//2   10
						["F","INVOICES",'old'],//1   9
						["F","I",'old']]	//0	   8	
						
						
var tickletypeandName =[["G","MARCH",'March'],
						["S","1-5",'March 1-5'],
						["S","6-10",'March 6-10'],
						["S","11-15",'March 11-15'],
					   	["S","16-20",'March 16-20'],
...
var dataRecd=[ 	 
				{	   
                    'name': [['205 Outfitters, Inc.'],
							 ['9800 E. Washington St.'],
							 ['Chicago, IL 60610-0117'],
							 ['312-555-0204'],
							 ['FAX: 312-555-0205'],
							 ['March 6, 20--'],
							 ['<img class="markingDatenew margintopminus25px" src="assets/images/mar_6-20.png" draggable="false"/>'],
			   ...
			   'alignClass':['floatcenter tmidalign fontInc',
						     'floatcenter14px',
						     'floatcenter14px',
						     'floatLeft tlefalign setbold',
			                 'leftRightParallel trigalign setbold',
							 'floatLeft1 tlefalign margintop25px',
			   			     'letCon',
     ...
     {	    
			  ...
			  'alignClass':['floatRight tlefalign marking2 snellround',
					...
					'crossAns':[[['Eggers','Beverly','Charleston','CPA','','','','SEE CharlestonEggers Beverly CPA'],['E',2]]]				
	    ...
	    {	    
			  ...
			  'alignClass':['floatcenter tmidalign',
					...
					'crossAns':[[['Imagine','Films','Inc','','','','','SEE 007 Spy Channel'],['I',2]]]					
			...
			{	    
			  ...
			  'alignClass':['background bg-text',
					...
					'aslash':[[],[],[[],[0]],[[0]],[],[],[],[],[],[[],[],[],[],[0,1,2,3],[],[]],[],[],[]],
					'numbering':[],
					'anumbering':['9 4 0','9 4 2','9 4 4','9 4 6','9 4 8'],
					'ainspect':2,
					'hintt':[''],
			...
			{	    
			  ...
			  'alignClass':['floatcenterImage1 tmidalign times',
					...
					'ainspect':1,
					'hintt':[''],
					'filinghint':['</br>Prepare a tickler card based on the contents of the letter. Disregard the destruction notation at this time.</br></br>'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['E',5],
		...
		{	    
                    'name':[['Belize National Communications Bureau','45 Avenue of the Americas','Belmopan, Belize'],
		...
		{	    
			  ...
			  'alignClass':['floatLeft tlefalign marking2 snellround',
							...
							'subinput',
							'substeping card2',
			  			    'floatLeft margintop20px tlefalign marking2 snellround',
			  			    'letCon snellround',
			  			    'letCon snellround',
			  			    'letCon snellround',
...
{	    
    ...
    {	    
		 ...
		 {        'name':[['<img class="markingDatenewleft" src="assets/images/apr_6-20.png" draggable="false"/>','<font class="marking3">April 2, 20--</font>'],
			  ...
			  'alignClass':[ 
					...
					'xfolderinfo':[['21',1]],
					'ansOrder':['D',0],
					'crossAns':[[['Allen','David','R','','','April 6, 20--','Information on pricing','SEE David Allen R'],['A',3]]]		
			...
			{	    
			  ...
			  'alignClass':['floatcenter tmidalign',
				    ...
				    'xfolderinfo':[['13',3]],
					'ansOrder':['E',3],
					'crossAns':[[['Ellens','Important','Television','Events','Inc','April 4, 20--','Cable channel available packages','SEE ELITE Inc'],['E',4]]]		
		...
		{	    
         ...
         {	    
			  ...
			  'alignClass':['floatcenter16px',
					...
					'folderinfo':['11',1],
					'xfolderinfo':[['17',1]],
					'ansOrder':['INTERNATIONAL COMPUTING CENTER',2]	,
	...
	{	    
			  ...
			  'alignClass':['floatcenter snellround',
							...
							'subinput',
							'substeping Card3',
			  			    'floatLeft tlefalign snellround margintopminus78px',
			  			    'letCon snellround',
			  			    'letCon snellround',
							'letCon3 snellround',
	    ...
	    {	    
			...
			{	    
			  ...
			  'alignClass':['background bg-text',
					...
					'folderinfo':['17',9],
					'xfolderinfo':[['17',6]],
					'crossAns':[[['Chicago','Technology','Inc','','','March 6, 20--','Information about the larger size fiber optic tubing including terms for quantity purchases','SEE CT Inc'],['CHICAGO',7]]]		
			 ...
			 {	    
			  ...
			  'alignClass':['floatcenter16px tmidalign times',
							...
							'substeping Card11',
			  			    ...
			  			    'letCon',
			  			    'floatLeft tlefalign',
			  			    'floatRight tlefalign2 margintopminus78px toBold'
							],
					'aslash':[[[0,1,2,3]],[],[],[],[],[],[],[],[],[],[],[],[],[]],
					'numbering':[],
					'anumbering':['0 0 0','0 0 2','0 0 4','0 0 6','0 0 8'],
					...
					'hintRus':[],
					'folderinfo':['19',3],
					'xfolderinfo':[['15',1],['8',2]],
					'ansOrder':['B',5],
					'crossAns':[[['Davis','Isaacson','and','Burns','Engineers','March 27, 20--','Meeting suggested to discuss testing of larger size fiber optic tubing','SEE Burns, Davis, and Isaacson Engineers'],['D',2]],[['Isaacson','Burns','and','Davis','Engineers','March 27, 20--','Meeting suggested to discuss testing of larger size fiber optic tubing','SEE Burns, Davis and Isaacson Engineers'],['I',3]]]	
...
for(var i=0;i<dataRecd.length; i++)
{
 ...
 dataRecd[5].subjectinput = ['','International','Computing','Center'];	
 dataRecd[12].subjectinput = ['Invoices','','',''];	
...
dataRecd[0].slash[4] =[[0]];
dataRecd[0].slash[15] =[[0,1],[0],[0],[0],[0]];
dataRecd[3].slash[2] =[[],[0]];
dataRecd[3].slash[3] =[[0]];
dataRecd[4].slash[2] =[[0]];
dataRecd[6].slash[2] =[[0]];
dataRecd[7].slash[2] =[[],[0]];
dataRecd[7].slash[3] =[[0]];
dataRecd[9].slash[11] =[[0,1],[0],[],[0],[0],[0]];
dataRecd[10].slash[3] =[[],[0]];
dataRecd[12].slash[5] =[[0]];
...
var simaction = {
	'alphabeticSimulation':'Review the 15 pieces of correspondence. Choose an action and then edit each letter as needed. Note<br/>that not all letters will require all actions. Once all correspondence has been coded, click the File<br/>button to file the correspondence.',
	...
	'leveling': 'Leveling: Determine the correct leveling by placing the correct level by each name.',
	'ticklefile': 'Add Tickler Card: Fill in the tickler card with the necessary information.',
	'Inspect':['Inspect: Determine whether the letter has been released for filing.'],
	'file':['Review the 15 pieces of correspondence and their associated cross-references and tickler cards. Drag each record to the correct file. Add guides and folders as needed. After the records have been rough-sorted into folders, fine-sort the records within each folder by clicking on each folder to open it.']
}
var simactionTitle = {
	'alphabeticSimulation':['Job 7: Correspondence Filing: Rules 1-10 and Tickler File Usage (Code)'],
	'file':['Job 7: Correspondence Filing: Rules 1-10 and<br/> Tickler File Usage (File)']
}