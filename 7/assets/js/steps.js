...
{	
	...
	changeCursorForNum();
	   ...
	   if( /Android|iPhone|iPad|iPod/i.test(navigator.userAgent) ) {
			$( '.snellround .names span, .snellroundex .names span').each(function () {
			...
			$('#reviewAnswer .swapArea .snellround  span,#reviewAnswer .swapArea .snellroundex  span').each(function () {
			...
			//$.each(val,function(i,v){
				...
				if(inx!=0){			
					if($('.simworkarea').hasClass('scaleCard') && applyTo == '.nameing'){
						var getLeft = posOf.position().left/0.36;
						var getTop = posOf.position().top/0.36;
					}else{
...
var enableEventlevel = function(mainObj,toThs,slashAns) {
	...
	//putNumber(mainObj,toThs,slashAns,i);
		...
		$('.floatRight   #name_15_0  > span,.floatRight #name_15_1 span:first-child,.floatRight   #name_15_2 span:first-child,.floatRight   #name_15_3 span:first-child,.floatRight #name_15_4 span:first-child, .floatRight   #name_11_0  > span,.floatRight #name_11_1 span:first-child,.floatRight   #name_11_3 span:first-child,.floatRight   #name_11_4 span:first-child,.floatRight #name_11_5 span:first-child,.trigalign  #name_2_0 span:first-child, .trigalign  #name_4_0 span:first-child, .floatRightauric #name_2_1 span:first-child, .floatRightauric2 #name_3_0 span:first-child, .leftRightParallel #name_3_1 span:first-child,.floatLeftFax1 #name_5_0 span:first-child, .floatleftIndentnew #name_12_0 span:first-child').addClass('notclick');
}
