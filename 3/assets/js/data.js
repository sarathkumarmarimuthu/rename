...
var dataRecdJob=[ {	'name':[['Richard Anderson'],['4110 W. Oak St.'],['Chicago, IL 60628-4110'],['312-555-0110']],
				...
				{	'name':[['Jennifer Taylor-Anderson'],['1625 Blue Fox Ct.'],['Park Ridge, IL 60068-1625'],['847-555-0206']],
					...
					'xfolderinfo':[[19,10]],
					'ansOrder':[19,8],
					'crossAns':[[['Stop','On','A','Dime','Assets','','','','SEE SODA Inc'],[19,18]]]
					},    //4
					{	
					...
					'xfolderinfo':[[21,4]],
					'ansOrder':[18,15],
					'crossAns':[[['Underwood','Amanda','Rustin','','','','','','SEE RustinUnderwood Amanda'],[21,5]]]
					},    //5
					{	
					...
					'ansOrder':[18,16],
					//'xfolderinfo':[16,0],
					//'crossAns':[['Park','and ','Store','RV','','RV Park and Store'],[16,0]]
					},      //7
					{
					...
					'ansOrder':[19,9],
					'xfolderinfo':[[18,1]],
					'crossAns':[[['Raj','Solanki','','','','','','','SEE Solanki Raj'],[18,1]]]
					},     //10
					{
					...
					'xfolderinfo':[[21,5]],
					'ansOrder':[20,1],
					'crossAns':[[['Unrah','and','Taylor','Brokerage','','','','','SEE Taylor and Unrah Brokerage'],[21,9]]]
					},       //12
					{	
				...
				{	
					...
					'slash':[[0,1,2,3]],
					'numbering':['0 0', '0 2','0 4','0 6','0 8'],
					'hintt':['This is a compound business name'],
					'hintRus':[],
					'folderinfo':[18,3],
					'xfolderinfo':[[20,5]],
					'ansOrder':[18,3],
					'crossAns':[[['Tibbetts','and','Randall','Tax','Accounting','','','','SEE Randall and Tibbetts Tax Accounting'],[20,7]]]
					}, // 7 
			   ...
			   {	
			        'name':[['St. Andrew\'s Parrish'],['980 N. River Dr.'],['Chicago, IL 60643-0980'],['708-555-0128']],
					'slash':[[1]],
					'numbering':['0 0', '0 2'],
					'hintt':['Refer to rule 6 for articles and particles'],
					'hintRus':[],
...
for(var i=0;i<dataRecdJob.length; i++)
{
	...
	//dataRecdJob[i].folderLocation = [0,i]
...
var dataRecd=[ {	    
                    'name':[['Department of Commerce'],['Chicago Office'],['(federal government)'],['P.O. Box 3000'],['Chicago, IL 60643-3000'],['312-555-0126']],
					'aslash':[],
					'anumbering':[],
					'hintt':['This is a federal government name. Refer to Rule 10C.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[21,6],
					'levelingAns':['United States Government','Commerce Dept (of)','Chicago office']
						
					}, //0
				 {	
				    'name':[['Taylor\'s Digital Systems'],['1530 W. Lake St.'],['Chicago, IL 60623-1530'],['312-555-0143']],
				    'aslash':[[0,1]],
				...
				{	
				    'name':[['City of Skokie'],['Recreation and Parks Dept.'],['City Hall'],['Skokie, IL 60077-1122'],['312-555-0145']],
					'aslash':[[0,1],[0,1,2]],
					'anumbering':['0 4','0 0','0 2','1 0','1 2','1 4','1 6'],
					'hintt':['This is a city government name. Refer to Rule 10A.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[19,6]					
					}, // 2 
				{	
				    'name':[['South End Attorneys'],['742 Pine St., Ste. 1201'],['Chicago, IL 60660-0742'],['708-555-0146']],
					'aslash':[[0,1]],
					'anumbering':['0 0','0 2','0 4'],
					'hintt':[''],
					'hintRus':[],
				...
				{	
				    'name':[['U.S. Dept. of the Treasury'],['Chicago Office'],['(federal government)'],['1810 N. California St.'],['Chicago, IL 60643-1810'],['312-555-0215']],
					'aslash':[],
					'anumbering':[],
					'hintt':['This is a federal government name. Refer to Rule 10C.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[21,8],
					'levelingAns':['United States Government','Treasury Department (of the)','Chicago office']
					}, // 4 
				{	
				    'name':[['Simon\'s Computers \'N More'],['3005 N. 112 Avenue'],['Chicago, IL 60657-3005'],['708-555-0147']],
					'aslash':[[0,1,2],[0,1,2],[0,1]],
					'anumbering':['0 0','0 2','0 4','0 6','2 0','2 2','1 2','1 4','1 6'],
					'hintt':['Refer to Rule 9 Identical Names.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[19,2]
					}, // 5 
				{	
				    'name':[['Urban Impressions, Inc.'],['4950 Bloom St.'],['Chicago, IL 60657-4950'],['312-555-0133']],
				    'aslash':[[0,1]],
					'anumbering':['0 0','0 2','0 4'],
					'hintt':[''],
					'hintRus':[],
				...
				{	
				    'name':[['Rick\'s N-E-Ware'],['2533 Providence Ave.'],['Evanston, IL 60203-2533'],['847-555-0117']],
					'aslash':[[0]],
					'anumbering':['0 0','0 2'],
					'hintt':[''],
					'hintRus':[],
				...
				{	
				    'name':[['Royale Banque'],['(Translation: Royal Bank)'],['141 S. Main Street'],['Chicago, IL 60660-0141'],['312-555-0130']],
					'aslash':[[],[0,1]],
					'anumbering':['1 3', '1 5'],
					...
					'folderinfo':[],
					'ansOrder':[18,10],
					'crossAns':[[['Royale','Banque','','','','','','','SEE Royal Bank'],[18,11]]]
					}, // 8 
						{	
				    'name':[['Simon\'s Computers \'N More'],['900 N. Walnut St.'],['Chicago, IL 60657-9000'],['312-555-0131']],
				    'aslash':[[0,1,2],[0,1,2],[0,1]],
					'anumbering':['0 0','0 2','0 4','0 6','2 0','2 2','1 2','1 4','1 6'],
					'hintt':['Refer to Rule 9 Identical Names.'],
					'hintRus':[],
					...
					'ansOrder':[19,3]
						...
						{	
				    'name':[['Federal Transit Adm.'],['U.S. Dept. of Transportation '],['(federal government)'],['1500 S. Stark Street, Suite 402'],['Chicago, IL 60657-1500'],['312-555-0134']],
					'aslash':[],
					'anumbering':[],
					'hintt':['This is a federal government name. Refer to Rule 10C.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[21,7],
					'levelingAns':['United States Government','Transportation Dept (of)','Federal Transit Adm']
					}, // 10 
						{	
				    'name':[['1 Stop Cleaners'],['45015 S. 101 St.'],['Chicago, IL 60630-4505'],['708-555-0135']],
					'aslash':[[0,1]],
					'anumbering':['0 0', '0 2','0 4'],
					'hintt':[''],
					'hintRus':[],
					...
					'ansOrder':[0,0]
						...
						{	
				    'name':[['City of Skokie'],['Fire Dept.'],['City Hall'],['Skokie, IL 60077-1122'],['708-555-0149']],
					'aslash':[[0,1],[0]],
					'anumbering':['0 4', '0 0','0 2','1 0','1 2'],
					'hintt':['This is a city government name. Refer to Rule 10A.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[19,4]
						...
						{	
				    'name':[['Simon\'s Computers \'N More'],['65800 N. 13th St.'],['Chicago, IL 60643-6580'],['312-555-0138']],
					'aslash':[[0,1,2],[0,1,2],[0,1]],
					'anumbering':['0 0','0 2','0 4','0 6','2 0','2 2','1 2','1 4','1 6'],
					'hintt':['Refer to Rule 9 Identical Names.'],
					'hintRus':[],
					...
					'ansOrder':[19,1]
						...
						{	
				    'name':[['Republiek Suriname'],['(Translation: Republic of Suriname)'],['6050 S. Embassy Drive'],['Chicago, IL 60643-6050'],['312-555-0142']],
					'aslash':[[],[0,1,2]],
					'anumbering':['1 7', '1 3','1 5'],
					'hintt':['Refer to Rule 10D Foreign Government Names.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[19,19],
					'crossAns':[[['Republiek','Suriname','','','','','','','SEE Suriname Republic of'],[18,6]]]
					}, // 14 
						{	
				    'name':[['Police Department'],['City of Skokie'],['City Hall'],['Skokie, IL 60077-1122'],['708-555-0140']],
                    'aslash':[[0,1],[0,1]],
					...
					'ansOrder':[19,5]
							...
							{	
				    'name':[['Taylor, Rustin, and Udey, Co.'],['(Changed its name to TRU CO)'],['650 Cascade Ave.'],['Chicago, IL 60643-0650'],['708-555-0141']],
					'aslash':[[],[3,4]],
					'anumbering':['1 3','1 5'],
					'hintt':['The new name is the filing segment for the original card. Prepare three cross-reference cards for the former compound name.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[20,9],
					'crossAns':[[['Taylor','Rustin','and','Udey','Co','','','','SEE TRU CO'],[20,2]],[['Rustin','Udey','and','Taylor','Co','','','','SEE TRU CO'],[18,14]],[['Udey','Taylor','and','Rustin','Co','','','','SEE TRU CO'],[21,2]]]
					}, // 16 
					
					{	
				    'name':[['Republique du Senegal'],['(Translation: Republic of Senegal)'],['6100 S. Embassy Dr.'],['Chicago, IL 60643-6070'],['312-555-0144']],
					'aslash':[[],[0,1,2]],
					'anumbering':['1 7', '1 3','1 5'],
					'hintt':['Refer to Rule 10D Foreign Government Names.'],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':[19,0],
					'crossAns':[[['Republique','du','Senegal','','','','','','SEE Senegal Republic of'],[18,7]]]	
					} // 17*/
...
var audhintSeq={"hint_0":["hint_0"],"hint_2":["hint_2"],"hint_4":["hint_4"],"hint_5":["hint_5"],"hint_8":["hint_8"],"hint_9":["hint_9"],"hint_10":["hint_10"],"hint_12":["hint_12"],"hint_13":["hint_13"],"hint_14":["hint_14"],"hint_15":["hint_15"],"hint_16":["hint_16"],"hint_17":["hint_17"]}
...
var audCcTxt = 	{
			'startbtn':['Welcome to Job 3 of the Records Management Simulation. Take a moment to review the alphabetic filing rules, the cross-reference rules, and directions for the module by clicking on the respective buttons.'],
			'directionsforjobs':[''],
			'overviewofauric':[''],
			'overviewofjob':[''],
			'sorting':[''],
...
var simaction = {
	...
	'leveling': 'Add Levels: Type in the correct information for each level.'
}	