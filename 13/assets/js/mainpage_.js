...
var codeForScoring = function(){
        ...
        //var folderLabelArray = ['CHICAGO', 'EVANSTON', 'GLENCOE', 'NORTHBROOK', 'OAK LAWN', 'OAK PARK', 'PARK RIDGE', 'WAUKEGAN'];
        ...
        function makeLettersToIndicesMapping() {
            ...
            //     if (foldertypeandName[j][0] != "G") {   // Job 13 only has a Guide indicator, otherwise folder has cards
         ...
         *
         * NOTE -- This must be customized for each job moving forward
		 * NOTE -- Job 13 only has a guide, so the folder labels are in the zero position in the array
         *
        ...
        function convertJobIndexToLevIndex(job_folder_index) {
            var folderLabel = folderLabelArray[job_folder_index];
            return convertLabelToLevIndex(folderLabel);
        }


        /**
         * For Job 13, define the folder Indices that do not have cards (type 'G' and 'S') using foldertypeandName.
         *
        ...
        function makeFolderLabels() {
            ...
            // NOTE: This may be able to be removed
        ...
        if (scoring_location == "localhost"){
            ...
            scoring_url = "Need a production url";
            scoring_token = "Need a production token";
        }
