...
var foldertypeandName =[['G','ILLINOIS'],['CHICAGO'],['EVANSTON'],['GLENCOE'],['NORTHBROOK'],['OAK LAWN'],['OAK PARK'],['PARK RIDGE'],['WAUKEGAN']];

//var foldertypeandName =[['WAUKEGAN'],['PARK RIDGE'],['OAK PARK'],['OAK LAWN'],['NORTHBROOK'],['GLENCOE'],['EVANSTON'],['CHICAGO'],['G','ILLINOIS']];
...
var dataRecd=[   {    
    				'name':[['Richard Anderson'],['4110 W. Oak St.'],['Chicago, IL 60628-4110'],['312-555-0110']],
					'aslash':[[0],[],[0,1],[]],
					'anumbering':['2 2','2 0','0 2','0 0'],
					'hintt':[],
					'hintAudio':[],
					'hintRus':[],
					'folderinfo':[],
				 ...
				 {	
					...
					'aslash':[[0,1],[],[0,1,2]],
					'anumbering':['2 4','2 0','2 2','0 0','0 2','0 4'],
					'hintt':[],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['OAK PARK',0]
		...
		{	
		       ...
		       {	
				    ...
				    'aslash':[[0,1],[],[0,1]],
					'anumbering':['2 2','2 0','0 4','0 0','0 2'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['WAUKEGAN',0]
				...
				{	
				    'name':[['RV Park & Store'],['117 E. Circle Drive'],['Chicago, IL 60619-0117'],['312-555-0116']],
					'aslash':[[0,1,2],[],[0,1]],
					'anumbering':['2 2','2 0','0 0','0 2','0 4','0 6'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['CHICAGO',6]	
				...
				{	
					...
					'ansOrder':['CHICAGO',13]
							...
							{	
				    'name':[['Randy\'s Restaurant'],['2010 NW 23rd Ave.'],['Chicago, IL 60623-2010'],['312-555-0115']],
					'aslash':[[0],[],[0,1]],
					'anumbering':['2 2','2 0','0 0','0 2'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['CHICAGO',2]
					...
					'aslash':[[2,3],[],[0,1]],
					'anumbering':['2 2','2 0','0 0','0 2','0 4'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['GLENCOE',0]	
					...
					'aslash':[[0,1],[],[],[],[0,1]],
					'anumbering':['4 2','4 0','0 0', '0 2', '0 4'],
					'hintt':[],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['CHICAGO',3],
				...
				{	
				    'name':[['Taylor & Randall Brokers'],['125 E Rice St.'],['Chicago, IL 60618-0125'],['312-555-0210']],
					'aslash':[[0,1,2],[],[0,1]],
					'anumbering':['2 2','2 0','0 0', '0 2', '0 4','0 6'],
				...
				{	
					...
					'aslash':[[0,1,2,3],[],[0,1,2]],
					'anumbering':['2 4','2 0','2 2','0 6', '0 2','0 4','0 8','0 0'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['OAK PARK',1]
			...
			{	
				    'name':[['South West Music School'],['1840 E. Lake St.'],['Chicago, IL 60618-1840'],['312-555-0136']],
					'aslash':[[0,1,2],[],[0,1]],
					'anumbering':['2 2','2 0','0 0','0 2','0 4','0 6'],
					'hintt':[''],
					'hintRus':[],
				...
				{	
					...
					'aslash':[[0,1],[],[],[0,1]],
					'anumbering':['3 2','3 0','0 4','0 2','0 0'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['CHICAGO',17],
				...
				{	
				    ...
				    'aslash':[[0,1],[],[0,1]],
					'anumbering':['2 2','2 0','0 2','0 0','0 4'],
					'hintt':[],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['CHICAGO',15]
				...
				{	
					...
					'aslash':[[0,1,2,3],[],[0,1]],
					'anumbering':['2 2','2 0','0 0','0 2','0 4','0 6','0 8'],
					'hintt':[''],
					'hintRus':[],
					'folderinfo':[],
					'ansOrder':['EVANSTON',0],
...
var simaction = {
	'alphabeticSimulation':'Code the location and name of each correspondent and then file the cards in geographic order<br/> behind the proper city guides. The state is considered first, then the city. The next units for filing<br/>purposes are in the name of the correspondent.',
	'Code': 'Code: Step 1:  Separate the units by inserting a diagonal slash (/) between the units.',
	'uIdentification':'Code: Step 2 (Units):  Indicate the primary unit (key unit) by clicking on it to underline it. Then, click<br/>on the remaining units in sequence to place the correct number above each identified unit.'
}	