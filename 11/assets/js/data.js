...
// uncodedCards details 
// xfolderinfo: starting placement of the object
// uncodedNum: coding ans
// uncards: contains text and folder answer.

var uncodedCards = [
{'uncards':[['','1 Way Direct','301 E. 6th Street','Northbrook, IL 60062-0301'],['Numbers',0,"A"]],'xfolderinfo':[['4',0]],'uncodedNum':"104"},//0
{'uncards':[['','007 Spy Channel','(A Division of Imagine! Films, Inc.)','600 South Fourth','Los Angeles, CA 90049-0007'],['Numbers',1,"A"]],'xfolderinfo':[['4',1]],'uncodedNum':"G"},//1
{'uncards':[['','205 Cable Systems, Inc.','9800 S. Washington St.','Evanston, IL 60203-9800'],['Numbers',2,"A"]],'xfolderinfo':[['4',2]],'uncodedNum':"104"},//2
{'uncards':[['','2001 Systems, Inc.','1050 Trails End','Oak Park, IL 60302-1050'],['Numbers',3,"A"]],'xfolderinfo':[['4',3]],'uncodedNum':"104"},//3
{'uncards':[['','Above and Beyond Insurance Co','965 N. Grove Street, Suite 201','Chicago, IL 60628-0965'],['A',0,"A"]],'xfolderinfo':[['4',4]],'uncodedNum':"101"},//4

{'uncards':[['','Airwaves Extraordinary','16078 S. Airwave Drive', 'Los Angeles, CA 90049-0167'],['A',1,"A"]],'xfolderinfo':[['4',5]],'uncodedNum':"G"},//5

{'uncards':[['','Applications'],['A',2,"A"]],'xfolderinfo':[['4',6]],'uncodedNum':"100"},//6

{'uncards':[['','Carter Chris','4027 N. Boyd Avenue','Chicago, IL 60643-4027'],['C',0,"A"]],'xfolderinfo':[['4',7]],'uncodedNum':"100"},//7

{'uncards':[['','Centro de Computacion International','SEE International Computing Center'],['C',1,"A"]],'xfolderinfo':[['4',8]],'uncodedNum':"103"},//8

{'uncards':[['','Chicago Broadband Association','1925 N. 27th Avenue','Chicago, IL 60660-1925'],['C',2,"A"]],'xfolderinfo':[['4',9]],'uncodedNum':"G"},//9

{'uncards':[['','Chicago City of Broadband','Communications Department','Municipal Building, B-210','Chicago, IL 60637-0111'],['C',3,"A"]],'xfolderinfo':[['4',10]],'uncodedNum':"G"},//10

{'uncards':[['','Chicago School of the Arts','806 S. Millbrook Road','Chicago, IL 60670-0806'],['C',4,"A"]],'xfolderinfo':[['4',11]],'uncodedNum':"105"},//11

{'uncards':[['','Crystal Net Inc The','6100 N. Roslyn Avenue','Northbrook, IL 60062-6100'],['C',5,"A"]],'xfolderinfo':[['4',12]],'uncodedNum':"102"},//12

{'uncards':[['','Imagine Films Inc','SEE','007 Spy Channel'],['I',0,"A"]],'xfolderinfo':[['4',13]],'uncodedNum':"G"},//13

{'uncards':[['','International Computing Center','1650 Conquistadora Blvd.','Cancun, Quintana Roo','MEXICO'],['I',1,"A"]],'xfolderinfo':[['4',14]],'uncodedNum':"103"},//14

{'uncards':[['','Invoices'],['I',2,"A"]],'xfolderinfo':[['4',15]],'uncodedNum':"104"}

];
//set number position to store folderlocation for every obj
$.each(uncodedCards,function(i,v){
	v.pos = i;
});
...
var dataRecd=[ 
			  ...
			  'alignClass':['SubInputTop',
							...
							'floatcenterAirwaves tmidalign setbold myclass',
			  			    'floatLeft4 floatleft4margin tlefalign setbold',
			  			    'leftRightParallel trigalign setbold',
			  			    'letCon',
							'letCon1',
							'subinput',
			  ...
			  'alignClass':['SubInputTop',
							...
							'floatleftIndent tlefalign margintopminus20px times',
							'subinput',
							'substeping testvisible1 Card12',
...
var audSeq = {
	...
	var audhintSeq={"hint_0":["hint_0"],"hint_1":["hint_1"],"hint_2":["hint_2"],"hint_3":["hint_3"],"hint_4":["hint_4"],"hint_5":["hint_5"],"hint_6":["hint_6"],"hint_7":["hint_7"],"hint_8":["hint_8"],"hint_9":["hint_9"],"hint_10":["hint_10"],"hint_11":["hint_11"],"hint_12":["hint_12"],"hint_13":["hint_13"],"hint_14":["hint_14"],"hint_15":["hint_15"],"hint_16":["hint_16"],"hint_17":["hint_17"]}
var audCcTxt = 	{
