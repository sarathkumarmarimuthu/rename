...
var putNumber = function(passObj,applyTo,slashAns){		//alert($(applyTo).parent().attr('class'));
	    ...
	    /*if( /iPhone|iPad|iPod/i.test(navigator.userAgent) ) {
			if($('.simworkarea').hasClass('scaleCard')){
				 $('.scaleCard .substeping .num').css({lineHeight:'30px'});
			}
		}*/
}
...
var enableEventlevel = function(mainObj,toThs,slashAns) {
	...
	//putNumber(mainObj,toThs,slashAns,i);
		$('.floatRightauric #name_2_1 span:first-child,.floatRightauric2 #name_3_0 span:first-child, .tlefalign1 #name_17_0 > span, .tlefalign1 #name_17_1 span:first-child,.tlefalign1 #name_17_3 span:first-child, .tlefalign1 #name_17_4 span:first-child, .tlefalign1 #name_17_6 span:first-child, .tlefalign2 #name_12_0 > span, .tlefalign2 #name_12_1 span:first-child, .tlefalign2 #name_12_3 span:first-child, .tlefalign2 #name_12_4 span:first-child, .tlefalign2 #name_12_6 span:first-child, .trigalign  #name_2_1 span:first-child, .leftRightParallel #name_3_1 span:first-child, .floatLeftFax1 #name_5_0 span:first-child').addClass('notclick');
