...
var dataRecd=[ 
                    ...
                    'name': [['Department of Tourism','Province of Alberta','Provincial Office Building, Suite 550','Calgary, AB T2K 4V8 CANADA'],
							['<img alt="Logo:Department of Tourism" class="chicago_logo" src="assets/images/alberta_logo.png" draggable="false"/>'],
							['March 5, 20--<img alt="Mar 10, 20--" class="markingDatenew" src="assets/images/mar_10-20.png" draggable="false"/>'],
							
							[''],
							['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							['<img alt="Destroy 3/30" class="markingRemindtopleft" src="assets/images/destroy_3-30.png" draggable="false"/>'],
							...
							['Sincerely,','<img alt="signature: Dale V. Jensen" class="markingSignature margintop10px" src="assets/images/dale.png" draggable="false"/>'],
							['Dale V. Jensen','Director'],
							['<img alt="Remind me to complete the survey on 3/13. TW" class="marginlefttop" src="assets/images/remind_me_3-13.png" draggable="false"/>'],
							['DVJ:jan','&nbsp;','Enclosure']],
			   'alignClass':['floatRight1 tlefalign', 
                    ...
                    'name':[['Centro de Computacion International','1650 Conquistadora Blvd.','Cancun, Quintana Roo','MEXICO'],
							['March 27, 20--'],
							['<img alt="Apr 1, 20--" class="markingDatenew" src="assets/images/apr_1-20.png" draggable="false"/>'],
							[''],
						   // ['International','Computing','Center','&nbsp;'],
							...
							['<img alt="signature: Roberto Suarez" class="markingSignature marginleft10px" src="assets/images/roberto_suarez.png" draggable="false"/>'],
							['<img alt="Open an individual folder. TW" class="marginlefttop margintopminus40px" src="assets/images/open_tw.png" draggable="false"/>'],
			  ...
			  'alignClass':['floatcenter16px',
                    ...
                    'name':[['Spirit Mountain Hot Springs','12990 Highway 97','Warm Springs, Oregon 97761','541-555-0989'],
							['March 5, 20--'],
							['<img alt="Mar 7, 20--" class="markingDatenew" src="assets/images/mar_7-20.png" draggable="false"/>'],
							[''],
						    ['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							...
							['<img alt="FL-A 3-7" class="markingNamesnew1 margintopminus78px" src="assets/images/fla_3-7.png" draggable="false"/>']],
			  'alignClass':['floatcenter snellround',
                    ...
                    'name':[['Chicago School of the Arts','806 S. Millbrook Road','Chicago, IL 60670-0806'],
						    ['<img alt="Logo:Chicago School of the Arts" class="chicago_art_logo" src="assets/images/chicago_art_logo.png" draggable="false"/>'],
							['March 18, 20--<img alt="Mar 20, 20--" class="markingDatenew" src="assets/images/mar_20-20.png" draggable="false"/>'],
							[''],
						    ['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							['Auric Systems, Inc.','1100 W. Tell Avenue','Chicago, IL 60657-1100'],
							...
							['Sincerely yours,','<img alt="signature: Charles Ingersol" class="markingSignature" src="assets/images/charles.png" draggable="false"/>'],
			  ...
			  'alignClass':['floatLeft2 tlefalign setbold times fontsize',
                    ...
                    'name':[['City of Chicago','Tax Collector','Municipal Building, A-107','Chicago, IL 60637-0111'],
							['March 30, 20--<img alt="Apr 2, 20--" class="markingDatenew" src="assets/images/apr_2-20.png" draggable="false"/>'],
							[''],
						    ['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							['Auric Systems, Inc.','1100 W. Tell Avenue','Chicago, IL 60657-1100'],
							...
							['Yours truly,','<img alt="signature: Linda Clark" class="markingSignature" src="assets/images/linda_clark.png" draggable="false"/>'],
							['Linda Clark','Deputy Clerk'],
							['<img alt="4/11 Remind me to check this record. TW" class="marginlefttop margintopminus25px" src="assets/images/remind_me_4-11.png" draggable="false"/>'],
							['LC:alt']],
			  'alignClass':['floatcenter16px',
			  			    'letCon',
							'subinput',
                    ...
                    'name':[['COPY'],
							...
							['Fax: 312-555-0102'],
							['March 6, 20--'],
							['<img alt="Prepare a cross-reference for the full company name: Chicago Technology, Inc. PJ" class="marginlefttop1" src="assets/images/prepare_cross.png" draggable="false"/>'],
							[''],
							['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
			  ...
			  'alignClass':['background bg-text',
                    ...
                    'name':[['COPY'],
							...
							['Sincerely yours,','&nbsp;'],
							['AURIC SYSTEMS, INC'],
							['<img alt="signature: Terri Williams" class="markingSignature" src="assets/images/terri.png" draggable="false"/>'],
			  ...
			  'alignClass':['background bg-text',
                    ...
                    'name':[['Burns, Davis, and Isaacson, Engineers','975 S. Salmon St., Suite 560','Chicago, IL 60660-0975'],
							...
							['','FAX: 312-555-0205'],
							['March 3, 20--'],
							['<img alt="Mar 3, 20--" class="markingDatenew" src="assets/images/mar_3-20.png" draggable="false"/>'],
							[''],
						    ['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							['','','Ms. Terri Williams, President','Auric Systems, Inc.','1100 W. Tell Avenue','Chicago, IL 60657-1100'],
							...
							['Sincerely yours','<img alt="signature: Sara Davis" class="markingSignature" src="assets/images/sara.png" draggable="false"/>'],
							['Sara Davis, Engineer'],
			  ...
			  'alignClass':['floatLeft2 tlefalign setbold times fontsize',
					...
					{	    
                    'name':[['<img alt="Logo:99 Electronic Repair Shop" class="electric_logo" src="assets/images/electronic_logo.png" draggable="false"/>'],
							['99 Electronic Repair Shop','14500 West Iowa Dr.','Chicago, IL 60643-1450'],
							['','312-555-0234'],
							['','FAX: 312-555-0235'],
							['April 2, 20--'],
							['<img alt="Apr 5, 20--" class="markingDatenew" src="assets/images/apr_5-20.png" draggable="false"/>'],
							[''],
							['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							['','','Ms. Terri Williams, President','Auric Systems, Inc.','1100 W. Tell Avenue','Chicago, IL 60657-1100'],
							['Dear Terri,'],
							...
							['<img alt="signature: Linda Adams" class="markingSignature" src="assets/images/linda_adams.png" draggable="false"/>'],
							['Linda Adams, Owner'],
							['<img alt="Open an individual folder. TW" class="marginlefttop" src="assets/images/open_tw.png" draggable="false"/>'],
							['LA:tw'],
							['Enclosure'],
							],
			  'alignClass':['letCon',
                    ...
                    'name':[['Communications Commission','State of Illinois','108 State Building','Chicago, IL 60628-0108'],
							['','312-555-0297'],
							['','FAX: 312-555-0299'],
							['15 March 20--<img alt="Mar 17, 20--" class="markingDatenew" src="assets/images/mar_17-20.png" draggable="false"/>'],
							[''],
							['&nbsp;','&nbsp;','&nbsp;','&nbsp;'],
							['','Ms. Terri Williams, President','Auric Systems, Inc.','1100 W. Tell Avenue','Chicago, IL 60657-1100'],
							['Dear Ms. Williams:'],
							...
							['Yours truly,'],
							['<img alt="signature: Janet S. Ollee" class="markingSignature" src="assets/images/janet.png" draggable="false"/>'],
							['Janet S. Ollee','Deputy Director'],
							['<img alt="4-14 TW" class="markingNamesnew1job6" src="assets/images/tw_4-14.png" draggable="false"/>'],
							['JSO:br'],
			  ...
			  'alignClass':['floatLeft2 tlefalign setbold times fontsize',
                    ...
                    'name':[['<img alt="Logo: Holly Farm Inn" class="hollo_logo" src="assets/images/hollo.png"  draggable="false"/>'],
							...
							['Sincerely yours,','<img alt="signature: Donna Edwards" class="markingSignature" src="assets/images/donna.png" draggable="false"/>','<img alt="3-21" class="markingNamesnew1job5" src="assets/images/321.png" draggable="false"/>','<img alt="FL-A 3-4" class="markingNamesnewjob5" src="assets/images/fla.png" draggable="false"/>'],
...
//						'ansOrder':['E',0],
                    ...
                    'name':[['The Crystal Net, Inc.'],
							...
							['<img alt="PJ 3-15" class="markingNamesnewjob5" src="assets/images/pj_3-15.png" draggable="false"/>'],
			  ...
			  'alignClass':['floatcenterBold tmidalign',
				 ...
				 {	    
                    'name':[['<img alt="CBS" class="cbs_logo" src="assets/images/cbs_logo.png"  draggable="false"/>'],
							['300 N. Brook Glen Road','Northbrook, IL 60062-0300'],
							['March 2, 20--'],
							['<img alt="Mar 4, 20--" class="markingDatenew" src="assets/images/mar_4-20.png" style="margin-left:430px;top:20px;" draggable="false"/>'],
							...
							[''],
							['Mr. Chas. S. Baker'],
							['<img alt="GN" class="markingNamesnewjob5" src="assets/images/gn.png"  draggable="false"/>']
							],
		       ...
		       'alignClass':['floatcenterjob5 tmidalign',
				...
				{	    
                    'name':[['4027 N. Boyd Avenue','Chicago, IL 60643-4027',],
							...
							['Sincerely yours,','<img alt="signature: Chris Carter" class="markingSignature" src="assets/images/chris_carter.png" draggable="false"/>'],
							['Chris Carter'],
							['<img alt="FL-B 3-10" class="markingNamesnewjob5" style="width:22%;" src="assets/images/flb_3-10.png"  draggable="false"/>'],
							['Enclosure'],
							['<img alt="3-16" class="markingNamesnew1job5" src="assets/images/316.png" draggable="false"/>']],
			   ...
			   'alignClass':['floatcenterImage3',
                    ...
                    'name':[['Imagination Cable Programming'],
							...
							['<img alt="TW 3-10" class="markingNamesnewImage" src="assets/images/tw_3-10.png"  draggable="false"/>'],
							['ri:ww'],
							['Enclosure']
							],
			...
			{ 'name':[['&nbsp;','&nbsp;','&nbsp;','&nbsp;','&nbsp;','Phone: 312.555.0123'],
			            ['Chicago Air Ways, Inc.','Chicago Tower','506 S. Sixth Street','Chicago, IL 60660-5060','&nbsp;','Fax: 312.555.0124'],
							...
							['<img alt="TW 4-12" class="markingNamesnewImage1" src="assets/images/tw_4-12.png"  draggable="false"/>'],
							['nv']
							],
		 ...
		 {        'name':[ ['<img alt="Apr 6, 20--" class="markingDatenewleft" src="assets/images/apr_6-20.png" draggable="false"/>','<font class="marking3">April 2, 20--</font>'],
			...
			{	    
                    'name':[['ELITE, Inc.','(Ellen\'s Important Television Events, Inc.)','Corporate Headquarters','900 North Sixth Avenue','Chicago IL 60630-9000'],
							...
							['<img alt="PJ" class="markingNamesnew2job5" src="assets/images/pj.png"  draggable="false"/>'],
							['ee:lh'],
							['Enclosure']
							],
			  'alignClass':['floatcenterjob5 tmidalign',
			...
			{	    
                    'name':[['Ms. Tara Brownstein','3202 Cloud Springs Road','Chicago, IL 60628-3202'],
							...
							['Tara Brownstein'],
							['<img alt="FL-A 4-15" class="markingNamesnewAbove1" src="assets/images/fla_4-15.png" draggable="false"/>']
		...
		{	    
                    'name':[['Chicago Simulcast, Inc.','1980 S. Grand Avenue','Chicago, IL 60630-1980'],
							...
							['Lynda Castleton'],
							['<img alt="FL-C 4-9" class="markingNamesnewImage1" src="assets/images/flc_4-9.png" draggable="false"/>'],
							['lc:jr'],
							],
